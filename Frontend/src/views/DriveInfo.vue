...
<div class="container">
    <div class="card my-4 col-12">
        ...
        <div class="card-body row">
            ...
            <h4 class="card-text col-md-3">Eligibility: {{ drive_det.eligbility }}</h4> 
    ...
    <div class="row">
        <div class="col-md-4" v-for="student in stu_appli" :key="student.id">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body row gap-3">
                    ...
                    <span class="card-text col-6">Descrtiption: {{ student.description }}</span>
